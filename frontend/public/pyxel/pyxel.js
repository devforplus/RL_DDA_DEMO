...
async function _loadPyodideAndPyxel(canvas) {
  ...
  // Install Pyxel runtime for Pyodide.
  // Prefer local wheel URL. Fallback to named package and finally micropip.
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        console.error("Failed to install Pyxel for Pyodide", e1, e2, e3);
        throw e3;
      }
    }
  }
